...
class Result extends Component {
  ...
  resultItemsHeader = (text) => {
    return (
      <div className="p-6 bg-white justify-center rounded-xl shadow-md flex items-center space-x-4 mr-4 w-full">
        <div>
  ...
  render() {
    return (
      <div className="container bg-gray-400 p-6">
        ...
        <div className="flex flex-row mt-4">{this.resultItems()}</div>
      </div>
    );
  }
}
